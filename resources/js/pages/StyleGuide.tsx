        ...
        <div className="min-h-screen bg-white text-[#1b1b18] dark:bg-[#0a0a0a]">
            ...
            <div className="pt-20 p-6 lg:p-8">
                ...
                <ul className="mt-4 space-y-2">
                    <li className="w-min px-4 py-2 bg-[#d4e6f7] text-white rounded-md shadow">#d4e6f7</li>
                    <li className="w-min px-4 py-2 bg-[#a9ccef] text-black rounded-md shadow">#a9ccef</li>
                    <li className="w-min px-4 py-2 bg-[#7eb2e7] text-white rounded-md shadow">#7eb2e7</li>
                </ul>
